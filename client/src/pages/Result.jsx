...
{/* Buttons */}
<div className='flex justify-center sm:justify-end itens-center flex-wrap gap-4 mt-6'>
  ...
  <a className=" px-8 py-2.5 text-white text-sm bg-gradient-to-r from via-violet-600 to bg-fuchsia-500 rounded-full hover:scale-105 transition-all duration-700"href="">Download Image</a>
</div>
