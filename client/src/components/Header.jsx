...
const Header = () => {
  return (
      ...
      <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20">
        {/*------left side------*/}
        <div>
        <h1 className="text-4xl sm:text-5xl 2xl:text-6xl font-bold text-neutral-700 leading-tight">
          ...
          <p className="my-6 text-[15px] text-gray-500">
            Remove the background from your images with our free online tool. <br className="max-sm:hidden"/>
            Upload an image, and AI will remove the background in seconds.  
          </p>
<div>
